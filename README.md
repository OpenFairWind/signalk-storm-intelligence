...
This source tree is the `2.5.1` release line. Version 2 uses the application identity **Storm Intelligence**. The earlier `weatherRadar` Signal K Resource API remains available as a deprecated read-only compatibility alias during v2; new integrations should use `stormIntelligence`.
