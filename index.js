...
const DEFAULTS = Object.freeze({
  ...
  lightningEnabled: false, lightningProviders: OBSERVATION_DEFAULTS.enabledProviders, lightningProviderSettings: {}, lightningLookbackMinutes: 30, lightningQueryRadiusNm: 120, lightningOverlayEnabled: true, lightningOverlayOpacity: 0.9, lightningWarningNm: 15, lightningAlarmNm: 8, lightningMinStrikes: 2, lightningNotificationPath: 'notifications.environment.weather.lightning',
  onboardEnvironmentEnabled: true, onboardEnvironmentHistoryMinutes: 30, onboardEnvironmentEvidenceWeight: 0.12,
...
module.exports = function (app) {
  ...
  plugin.start = function (settings = {}) {
    ...
    environmentFusion=new EnvironmentFusion({historyMinutes:cfg.onboardEnvironmentHistoryMinutes})
  ...
  plugin.schema = () => ({ type: 'object', properties: {
    ...
    lightningEnabled:{title:'Lightning observation fusion',type:'boolean',default:false}, lightningProviders:{title:'Enabled lightning observation providers',type:'array',uniqueItems:true,default:DEFAULTS.lightningProviders,items:{type:'string',enum:[...OBSERVATION_ADAPTERS.keys()]}}, lightningProviderSettings:observationProviderSettingsSchema(OBSERVATION_ADAPTERS), lightningLookbackMinutes:{title:'Lightning lookback (minutes)',type:'integer',minimum:5,maximum:180,default:30}, lightningQueryRadiusNm:{title:'Lightning query radius (NM)',type:'number',minimum:10,maximum:500,default:120}, lightningOverlayEnabled:{title:'Show lightning overlay in plotters',type:'boolean',default:true}, lightningOverlayOpacity:{title:'Lightning overlay opacity',type:'number',minimum:0,maximum:1,default:.9}, lightningWarningNm:{title:'Lightning warning radius (NM)',type:'number',minimum:1,default:15}, lightningAlarmNm:{title:'Lightning alarm radius (NM)',type:'number',minimum:.5,default:8}, lightningMinStrikes:{title:'Minimum recent strikes for proximity warning',type:'integer',minimum:1,default:2}, lightningNotificationPath:{title:'Lightning Signal K notification path',type:'string',default:DEFAULTS.lightningNotificationPath},
    onboardEnvironmentEnabled:{title:'Fuse onboard environmental sensors',type:'boolean',default:true}, onboardEnvironmentHistoryMinutes:{title:'Onboard environment trend window (minutes)',type:'integer',minimum:5,maximum:180,default:30}, onboardEnvironmentEvidenceWeight:{title:'Maximum onboard evidence confidence contribution',type:'number',minimum:0,maximum:.3,default:.12},
